...
- `user_profile.csv`: Perfil de los usuarios con columnas como edad, ciudad, plan contratado y métricas de uso.
- `usage.csv`: Registro de llamadas y mensajes consumidos por los usuarios.
